	...
	<div class="container">
		...
		<div class="col-sm-4">
			<fieldset>
				...
				<form role="form" action="CONTmodificar.php" method="get">
					...
					<input id="action" type="hidden" name="action" value="modificar"/>
				  	...
				  	<button type="cancel" onclick="javascript:window.location='../publico/index.php';" class="btn btn-danger">Cancelar</button>
